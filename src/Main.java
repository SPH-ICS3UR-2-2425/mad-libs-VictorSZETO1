...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (str < 7) {
			...
			System.out.println(noun1+verb1+"and decided to see if they had any "+verb2+noun2);
			System.out.println("but while "+name+" was looking around he saw his best frind"+name2+verb+"a"+pet);
			System.out.println("since "+name+"is a solid "+str+"/10 in strength he decides to punch his friend since "+pet+" is his favorite animal however he is too weak and gets knocked out");
			System.out.println("the last thing "+name+" saw was a "+verb3+noun3);
		}
		if (str > 7) {
			System.out.println("ok " + name + " your to strong for the program :( (score to high " + str + "/10");
